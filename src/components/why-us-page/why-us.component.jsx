			...
			<WInfo>
				<ul>
					...
					<li>
						...
						<span className="text">Используем для ремонта новые запчасти</span>
					</li>
					<li>
						<span className="img">
							<img src={mechanic} alt="" />
						</span>
						<span className="text">Квалифицированный персонал</span>
					</li>
					<li>
						<span className="img">
							<img src={reward} alt="" />
						</span>
						<span className="text">Персональная гарантия</span>
					</li>
					<li>
						<span className="img">
				...
				<WReviewsContainer>
					...
					<ThirdReview>
						...
						<a href={reviews} target="_blank" rel="noreferrer">
							<button>Смотреть все отзывы<img src={externalLink} alt="" /></button>
						</a>
					</ThirdReview>
				</WReviewsContainer>
			</WReviews>
